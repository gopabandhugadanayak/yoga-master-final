                ...
                {classes.map((cls, index) => (
                    ...
                    >
                        <div className="relative h-48">
                            ...
                            >
                                <div className="absolute inset-0 flex items-center justify-center">
                                    ...
                                    <button onClick={() => handelSelect(cls._id)} title={role === 'admin' || role === 'salon' ? 'salon/Admin Can not be able to select ' ? cls.availableSeats <1 : 'No seat avalible' : 'You can select this service' } disabled={role === 'admin' || role === 'salon' || cls.availableSeats < 1} className="px-4 py-2 text-white disabled:bg-red-300 bg-secondary duration-300 rounded hover:bg-red-700">
                                        Select
                                    </button>
                        ...
                        <div className="px-6 py-2">
                            ...
                            <p className="text-gray-500 text-xs">salon : {cls.salonName}</p>
