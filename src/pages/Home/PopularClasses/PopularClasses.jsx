...
const PopularClasses = () => {
    ...
    return (
        <div className='md:w-[80%] mx-auto my-36'>
            <div className="">
                <h1 className='text-5xl font-bold text-center'>Our <span className='text-secondary'>Popular</span> Services</h1>
                <div className="w-[40%] text-center mx-auto my-4">
                    <p className='text-gray-500'>Explore our Popular Services . Here is some popular classes based  on How many  enrolled</p>
                </div>
            </div>
